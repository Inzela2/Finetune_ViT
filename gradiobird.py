...
class_names = [
    ...
    '027.Shiny_Cowbird', '028.Brown_Creeper', '029.American_Crow', '030.Fish_Crow',
    ...
    '040.Olive_sided_Flycatcher', '041.Scissor_tailed_Flycatcher', '042.Vermilion_Flycatcher',
    ...
    '054.Blue_Grosbeak', '055.Evening_Grosbeak', '056.Pine_Grosbeak', '057.Rose_breasted_Grosbeak',
    ...
    '081.Pied_Kingfisher', '082.Ringed_Kingfisher', '083.White_breasted_Kingfisher',
    ...
    '096.Hooded_Oriole', '097.Orchard_Oriole', '098.Scott_Oriole', '099.Ovenbird',
    '100.Brown_Pelican', '101.White_Pelican', '102.Western_Wood_Pewee', '103.Sayornis',
    '104.American_Pipit', '105.Whip_poor_Will', '106.Horned_Puffin', '107.Common_Raven',
    '108.White_necked_Raven', '109.American_Redstart', '110.Geococcyx', '111.Loggerhead_Shrike',
    '112.Great_Grey_Shrike', '113.Baird_Sparrow', '114.Black_throated_Sparrow', '115.Brewer_Sparrow',
    ...
    '148.Green_tailed_Towhee', '149.Brown_Thrasher', '150.Sage_Thrasher', '151.Black_capped_Vireo',
    ...
    '168.Kentucky_Warbler', '169.Magnolia_Warbler', '170.Mourning_Warbler', '171.Myrtle_Warbler',
    ...
    '188.Pileated_Woodpecker', '189.Red_bellied_Woodpecker', '190.Red_cockaded_Woodpecker', '191.Red_headed_Woodpecker',
    '192.Downy_Woodpecker', '193.Bewick_Wren', '194.Cactus_Wren', '195.Carolina_Wren',
    '196.House_Wren', '197.Marsh_Wren', '198.Rock_Wren', '199.Winter_Wren',
    '200.Common_Yellowthroat'
]

# Load model and processor
model_path = "C:/Users/asus/Downloads/CLIP/Dataset/results/checkpoint-2064"
...
def predict_species(image):
    ...
    return f"Predicted Bird Species: {predicted_class_name}"
...
interface = gr.Interface(
    ...
    description="Upload an image of a bird, and I'll try to detect its species!",
    theme="default",
    article="<p>Upload an image of a bird, and I'll try to detect its species using a fine-tuned CLIP model.</p>"
)
